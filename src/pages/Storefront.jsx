...
export const Storefront = ({ storeId, navigate }) => {
  ...
  if (!store) {
    return (
      <div style={{ maxWidth: 600, margin: '80px auto', textAlign: 'center', padding: '0 20px' }}>
        <h2 style={{ fontSize: '1.6rem', fontWeight: 800 }}>Store Not Found</h2>
  ...
  return (
    <div className="animate-fade-in" style={{ paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 1280, margin: '-60px auto 32px', padding: '0 24px', position: 'relative', zIndex: 10 }}>
        <div className="clean-card" style={{ padding: '24px 28px', borderRadius: 16 }}>
          ...
          <div style={{
            ...
            {[
              ...
              { id: 'reviews', label: `Reviews (${reviews.length > 0 ? reviews.length : 12})` }
            ].map(tab => (
              <button
                key={tab.id}
